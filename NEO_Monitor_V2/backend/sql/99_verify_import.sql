...
------------------------------------------------------------
-- 9. CONTEXTO OBSERVACIONAL
------------------------------------------------------------
PRINT ''
PRINT '9. Tabelas de Contexto (Observação):'
PRINT '====================================='
GO

SELECT 'Centros de Observação' AS Tabela, COUNT(*) AS Qtd FROM dbo.Centro_Observacao
UNION ALL
SELECT 'Equipamentos', COUNT(*) FROM dbo.Equipamento
UNION ALL
SELECT 'Astrónomos', COUNT(*) FROM dbo.Astronomo
UNION ALL
SELECT 'Software', COUNT(*) FROM dbo.Software
UNION ALL
SELECT 'Observações (Total)', COUNT(*) FROM dbo.Observacao
UNION ALL
SELECT 'Observações (REFERENCIA)', COUNT(*) FROM dbo.Observacao WHERE modo='REFERENCIA';
GO
